	...
	tests := []struct {
		...
		},
		{
			...
			want: map[string]string{
				...
				"Speech":       "speech",
				"Yara":         "yara",
				"ProbeMode":    "probe_mode,omitempty",
				"ProbeState":   "probe_state,omitempty",
				"ProbeTimings": "probe_timings,omitempty",
				"ProbeErrors":  "probe_errors,omitempty",
				"Cached":       "cached,omitempty",
