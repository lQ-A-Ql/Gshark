...
func engineDomainOwners() map[string]string {
	return map[string]string{
		...
		"rule_manager_security.go":              "yara_hunting_rules",
		"rule_manager_yara.go":                  "yara_hunting_rules",
		...
		"tool_runtime_validator.go":             "runtime_integration",
...
func allowedServiceCrossControllerMethods() map[string]struct{} {
	return map[string]struct{}{
		...
		"service_analysis.go:mediaAnalysisWithForceAndContext": {},
		...
		"service_tools.go:SetHuntingRuntimeConfig":             {},
