...
export const sourceSizeBudgets = [
  ...
  {
    path: "src/app/integrations/wire/streamWireDtos.ts",
    maxLines: 20,
    reason: "stream wire DTOs should only describe raw stream index and packet resource payload fields",
  },
  {
    path: "src/app/integrations/wire/streamPayloadWireDtos.ts",
    maxLines: 50,
  ...
  {
    path: "src/app/integrations/wire/c2SampleWireDtos.ts",
    maxLines: 130,
    reason: "C2 sample wire DTOs should only describe raw family, indicator, and aggregate payload fields",
  },
  {
  ...
  {
    path: "src/app/integrations/wire/huntingWireDtos.ts",
    maxLines: 25,
