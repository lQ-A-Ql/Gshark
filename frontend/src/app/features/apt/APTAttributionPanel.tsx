  ...
  return (
    <div className="space-y-2">
      {notes.map((note, index) => (
        <div
          key={`${note}-${index}`}
          className="meow-tile border-indigo-100 bg-indigo-50/60 px-3 py-2 text-xs leading-5 text-indigo-800"
        >
          {note}
        </div>
      ))}
  ...
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-1 gap-0 md:grid-cols-4">
        <div className="meow-tile border-emerald-100 bg-emerald-50/50 px-4 py-3">
        ...
        <div className="meow-tile border-amber-100 bg-amber-50/50 px-4 py-3">
        ...
        <div className="meow-soft-fill px-4 py-3">
        ...
        <div className="meow-tile border-rose-100 bg-rose-50/50 px-4 py-3">
      ...
      <div className="meow-tile border-indigo-100 bg-indigo-50/30 px-4 py-3">
