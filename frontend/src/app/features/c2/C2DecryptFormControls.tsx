...
function RawKeyHint() {
  return (
    <div className="meow-tile border-amber-200 bg-amber-50 px-3 py-2 text-xs leading-5 text-amber-900">
  ...
  return (
    <label className="block text-xs">
      ...
      <textarea
        ...
        className="meow-soft-fill min-h-28 w-full px-3 py-2 font-mono text-[11px] text-slate-700 outline-none focus:border-rose-300 focus:ring-4 focus:ring-rose-100"
  ...
  return (
    <label className="block text-xs">
      ...
      <input
        ...
        className="meow-soft-fill h-9 w-full px-3 font-mono text-[11px] text-slate-700 outline-none focus:border-rose-300 focus:ring-4 focus:ring-rose-100"
      />
    </label>
  );
}
...
function KeyModeHint({ icon, children }: { icon: string; children: ReactNode }) {
  return (
    <div className="meow-tile flex gap-2 border-slate-200 bg-slate-50 px-3 py-2 text-xs leading-5 text-slate-600">
