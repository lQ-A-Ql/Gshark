...
const C2_CANDIDATE_TABLE_HEADER_CLASS = "meow-tile-header text-slate-700";
const C2_CANDIDATE_TABLE_ROW_CLASS = "last:border-b-0 odd:bg-transparent even:bg-[var(--meow-table-selected-bg)]";
    ...
    <DataTable<C2IndicatorRecord>
      ...
      rowClassName={(item, index) =>
        cn(
          ...
          expandedRows.has(candidateRowKey(item, index)) ? "bg-rose-50/25" : "hover:bg-[var(--meow-table-hover-bg)]",
        )
      }
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <button
                    ...
                    className={cn(
                      ...
                      expanded ? "meow-risk-accent text-rose-700" : "text-slate-600 hover:text-rose-700",
                    )}
                  >
