  ...
  return (
    <div className="min-w-0 space-y-2">
      <div className="flex flex-wrap items-center gap-2">
        ...
        {text && (
          <button
            className="meow-soft-fill inline-flex items-center gap-1 px-2 py-0.5 text-[11px] hover:bg-accent"
      ...
      {text ? (
        <div className="meow-soft-fill max-w-[28rem] px-2.5 py-2 text-[11px] leading-5 text-emerald-950">
          <div className="line-clamp-4 whitespace-pre-wrap break-words">{text}</div>
        </div>
      ) : progress ? (
        <div className="meow-soft-fill max-w-[22rem] px-2.5 py-2">
...
export function ExportActionsCell({
  ...
  return (
    <div className="meow-soft-fill w-full max-w-[13rem] p-2">
      <div className="flex flex-col gap-2">
        ...
        <div className="meow-soft-fill px-2.5 py-2 text-[11px] text-slate-500">
