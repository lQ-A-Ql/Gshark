...
export function ThreatHuntingConfigPanel({
  ...
  return (
    <div className="meow-tile-header shrink-0 border-b border-slate-200 p-4">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-4">
        <label className="flex flex-col gap-1 text-xs">
          ...
          <input
            ...
            className="meow-field h-9 px-3 text-foreground outline-none transition"
        ...
        <div className="col-span-1 flex flex-wrap items-center gap-2 md:col-span-2 xl:col-span-4">
          <button
            ...
            className="meow-control h-9 px-3.5 text-xs font-medium text-slate-700 transition disabled:cursor-not-allowed disabled:opacity-50"
          >
            重新读取参数
          </button>
          <button
            ...
            disabled={!backendConnected || configBusy || huntBusy}
            className="meow-control h-9 border-blue-200/18 px-3.5 text-xs font-medium text-blue-700 transition disabled:cursor-not-allowed disabled:opacity-50"
          >
            保存并重跑狩猎
          </button>
          <button
            ...
            disabled={!backendConnected || configBusy || huntBusy}
            className="meow-control h-9 border-emerald-200/18 px-3.5 text-xs font-medium text-emerald-700 transition disabled:cursor-not-allowed disabled:opacity-50"
          >
            仅重跑（不保存）
          </button>
