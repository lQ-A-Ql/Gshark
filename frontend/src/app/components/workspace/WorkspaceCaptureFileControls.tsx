...
export function CaptureFileControls({
  ...
  return (
    <div className="meow-tile-toolbar flex min-w-0 flex-wrap items-center gap-2 px-2 py-1">
      <div className="meow-field flex w-[320px] min-w-[220px] items-center overflow-hidden">
      ...
      <button
        ...
        disabled={disabled}
        className="meow-control flex items-center gap-1 px-3 py-1 text-xs text-foreground transition-all disabled:cursor-not-allowed disabled:opacity-60"
