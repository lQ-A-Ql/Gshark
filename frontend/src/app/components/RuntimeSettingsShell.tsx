...
export function RuntimeSettingsActions({
  ...
  return (
    <div className="meow-tile-toolbar flex items-center gap-2 border-x-0 border-t-0 px-5 py-3">
      <button
        onClick={onRefresh}
        disabled={busy || loading || !backendConnected}
        className="meow-control inline-flex h-10 items-center gap-2 px-3.5 text-xs font-medium text-slate-700 transition disabled:cursor-not-allowed disabled:opacity-60"
      >
      ...
      <button
        ...
        className="meow-control-primary inline-flex h-10 items-center gap-2 px-3.5 text-xs font-medium transition disabled:cursor-not-allowed disabled:opacity-60"
      >
        ...
        : probeState === "probing_full"
          ...
          : probeState === "timeout_background"
            ...
            : probeTransportError
              ...
              : diagnosticsText;
  return (
    <div className="meow-tile-toolbar border-x-0 border-b-0 px-5 py-4">
      <div className="meow-soft-fill flex items-start gap-2 px-3 py-3 text-[11px] leading-5 text-slate-500">
