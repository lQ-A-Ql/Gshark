...
export function PayloadWebShellSourceList({
  ...
  if (!hasCapture) {
    return (
      <div className="meow-tile mb-3 border-slate-100 bg-slate-50/80 px-3 py-2 text-xs leading-5 text-slate-500">
  ...
  if (loading) {
    return (
      <div className="meow-tile mb-3 border-cyan-100 bg-cyan-50/70 px-3 py-2 text-xs font-medium text-cyan-800">
  ...
  if (error) {
    return (
      <div className="meow-tile mb-3 border-amber-200 bg-amber-50 px-3 py-2 text-xs font-medium text-amber-800">
        {error}
      </div>
    );
  }
  ...
  return (
    <div className="meow-tile mb-3 overflow-hidden border-cyan-100">
