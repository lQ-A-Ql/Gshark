...
export function HTTPLoginBruteforceAlert({ bruteforceCount }: { bruteforceCount: number }) {
  return (
    <div className="meow-tile border-rose-200 bg-rose-50/80 p-4 text-sm text-rose-800">
...
export function HTTPLoginSuccessHint() {
  return (
    <div className="meow-tile border-emerald-200 bg-emerald-50/70 p-4 text-sm text-emerald-800">
      <div className="flex items-center gap-2 font-semibold">
