...
export function HttpStreamToolbar({
  ...
  return (
    <div className="meow-tile-toolbar meow-workbench-panel flex shrink-0 flex-wrap items-center justify-between gap-3 border-x-0 border-t-0 px-4 py-2">
      <StreamSearchBar
        value={search}
      ...
      <button
        onClick={onExportAll}
        className="meow-control meow-evidence-accent flex items-center gap-1 px-3 py-1.5 text-xs text-foreground transition-all hover:text-accent-foreground"
      >
