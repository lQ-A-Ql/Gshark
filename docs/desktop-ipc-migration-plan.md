...
- Desktop dev with current bindings: same as desktop release for typed IPC data-plane failures; explicit control-plane HTTP fallback through `fallbackBridge` remains available for runtime/MCP/capture/TLS compatibility.
